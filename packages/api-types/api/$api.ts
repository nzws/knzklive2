  ...
  return {
    v1: {
        ...
        mastodon: {
          callback: {
            post: (option: { body: Methods0['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods0['post']['resBody']>(prefix, PATH0, POST, option).text(),
            $post: (option: { body: Methods0['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods0['post']['resBody']>(prefix, PATH0, POST, option).text().then(r => r.body),
            $path: () => `${prefix}${PATH0}`
          },
          login: {
      ...
      lives: {
          ...
          return {
            comments: {
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods5['get']['resBody']>(prefix, `${prefix2}${PATH6}`, GET, option).json(),
              $get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods5['get']['resBody']>(prefix, `${prefix2}${PATH6}`, GET, option).json().then(r => r.body),
              post: (option: { body: Methods5['post']['reqBody'], headers: Methods5['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods5['post']['resBody']>(prefix, `${prefix2}${PATH6}`, POST, option).json(),
              $post: (option: { body: Methods5['post']['reqBody'], headers: Methods5['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods5['post']['resBody']>(prefix, `${prefix2}${PATH6}`, POST, option).json().then(r => r.body),
              delete: (option: { body: Methods5['delete']['reqBody'], headers: Methods5['delete']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods5['delete']['resBody']>(prefix, `${prefix2}${PATH6}`, DELETE, option).json(),
              $delete: (option: { body: Methods5['delete']['reqBody'], headers: Methods5['delete']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods5['delete']['resBody']>(prefix, `${prefix2}${PATH6}`, DELETE, option).json().then(r => r.body),
        ...
        explore: {
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods7['get']['resBody']>(prefix, PATH8, GET, option).json(),
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods7['get']['resBody']>(prefix, PATH8, GET, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH8}`
        },
        find: {
      ...
      streams: {
          ...
          return {
            action: {
              post: (option: { body: Methods11['post']['reqBody'], headers: Methods11['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods11['post']['resBody']>(prefix, `${prefix2}${PATH11}`, POST, option).json(),
              $post: (option: { body: Methods11['post']['reqBody'], headers: Methods11['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods11['post']['resBody']>(prefix, `${prefix2}${PATH11}`, POST, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH11}`
            },
            url: {
              get: (option: { headers: Methods12['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods12['get']['resBody']>(prefix, `${prefix2}${PATH7}`, GET, option).json(),
              $get: (option: { headers: Methods12['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods12['get']['resBody']>(prefix, `${prefix2}${PATH7}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH7}`
            },
            patch: (option: { body: Methods10['patch']['reqBody'], headers: Methods10['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods10['patch']['resBody']>(prefix, prefix2, PATCH, option).json(),
            $patch: (option: { body: Methods10['patch']['reqBody'], headers: Methods10['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods10['patch']['resBody']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
        ...
        post: (option: { body: Methods9['post']['reqBody'], headers: Methods9['post']['reqHeaders'], config?: T | undefined }) =>
          fetch<Methods9['post']['resBody']>(prefix, PATH10, POST, option).json(),
        $post: (option: { body: Methods9['post']['reqBody'], headers: Methods9['post']['reqHeaders'], config?: T | undefined }) =>
          fetch<Methods9['post']['resBody']>(prefix, PATH10, POST, option).json().then(r => r.body),
        $path: () => `${prefix}${PATH10}`
      },
      tenants: {
        _tenantDomain: (val2: number | string) => {
          ...
          return {
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods13['get']['resBody']>(prefix, prefix2, GET, option).json(),
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods13['get']['resBody']>(prefix, prefix2, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        }
      },
      users: {
        _userId: (val2: number) => {
          ...
          return {
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods14['get']['resBody']>(prefix, prefix2, GET, option).json(),
            $get: (option?: { config?: T | undefined } | undefined) =>

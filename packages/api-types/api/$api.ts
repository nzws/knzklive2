...
import type { Methods as Methods23 } from './v1/tenants/find/_slugOrId/lives';
            ...
            return {
              lives: {
                get: (
                  option?:
                    | {
                        query?: Methods23['get']['query'] | undefined;
                ...
                $path: (
                  option?:
                    | {
                        method?: 'get' | undefined;
                        query: Methods23['get']['query'];
                      }
                    | undefined
                ) =>
                  `${prefix}${prefix3}${PATH20}${
                    option && option.query
                      ? `?${dataToURLString(option.query)}`
                      : ''
                  }`

...
import type { Methods as Methods19 } from './v1/tenants'
import type { Methods as Methods20 } from './v1/tenants/_tenantId@number'
import type { Methods as Methods21 } from './v1/tenants/_tenantId@number/stream-status'
import type { Methods as Methods22 } from './v1/tenants/find/_key'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH16 = '/action'
  const PATH17 = '/v1/tenants'
  const PATH18 = '/stream-status'
    ...
    v1: {
          ...
          return {
            comments: {
              get: (option?: { headers?: Methods9['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods9['get']['resBody']>(prefix, `${prefix2}${PATH9}`, GET, option).json(),
              $get: (option?: { headers?: Methods9['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods9['get']['resBody']>(prefix, `${prefix2}${PATH9}`, GET, option).json().then(r => r.body),
              post: (option: { body: Methods9['post']['reqBody'], headers: Methods9['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods9['post']['resBody']>(prefix, `${prefix2}${PATH9}`, POST, option).json(),
              $post: (option: { body: Methods9['post']['reqBody'], headers: Methods9['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods9['post']['resBody']>(prefix, `${prefix2}${PATH9}`, POST, option).json().then(r => r.body),
              delete: (option: { body: Methods9['delete']['reqBody'], headers: Methods9['delete']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods9['delete']['resBody']>(prefix, `${prefix2}${PATH9}`, DELETE, option).json(),
              $delete: (option: { body: Methods9['delete']['reqBody'], headers: Methods9['delete']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods9['delete']['resBody']>(prefix, `${prefix2}${PATH9}`, DELETE, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH9}`
            },
            count: {
              get: (option?: { headers?: Methods10['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods10['get']['resBody']>(prefix, `${prefix2}${PATH10}`, GET, option).json(),
              $get: (option?: { headers?: Methods10['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods10['get']['resBody']>(prefix, `${prefix2}${PATH10}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH10}`
            },
            url: {
              get: (option?: { headers?: Methods11['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods11['get']['resBody']>(prefix, `${prefix2}${PATH11}`, GET, option).json(),
              $get: (option?: { headers?: Methods11['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods11['get']['resBody']>(prefix, `${prefix2}${PATH11}`, GET, option).json().then(r => r.body),
            ...
            return {
              top: {
                get: (option?: { headers?: Methods14['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods14['get']['resBody']>(prefix, `${prefix3}${PATH14}`, GET, option).json(),
                $get: (option?: { headers?: Methods14['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods14['get']['resBody']>(prefix, `${prefix3}${PATH14}`, GET, option).json().then(r => r.body),
      ...
      streams: {
        _liveId: (val2: number) => {
          ...
          return {
            action: {
              post: (option: { body: Methods17['post']['reqBody'], headers: Methods17['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods17['post']['resBody']>(prefix, `${prefix2}${PATH16}`, POST, option).json(),
              $post: (option: { body: Methods17['post']['reqBody'], headers: Methods17['post']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods17['post']['resBody']>(prefix, `${prefix2}${PATH16}`, POST, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH16}`
            },
            url: {
              get: (option: { headers: Methods18['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods18['get']['resBody']>(prefix, `${prefix2}${PATH11}`, GET, option).json(),
              $get: (option: { headers: Methods18['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods18['get']['resBody']>(prefix, `${prefix2}${PATH11}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH11}`
            },
            patch: (option: { body: Methods16['patch']['reqBody'], headers: Methods16['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods16['patch']['resBody']>(prefix, prefix2, PATCH, option).json(),
            $patch: (option: { body: Methods16['patch']['reqBody'], headers: Methods16['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods16['patch']['resBody']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
            get: (option: { headers: Methods16['get']['reqHeaders'], config?: T | undefined }) =>
        ...
        post: (option: { body: Methods15['post']['reqBody'], headers: Methods15['post']['reqHeaders'], config?: T | undefined }) =>
      ...
      tenants: {
        _tenantId: (val2: number) => {
          ...
          return {
            stream_status: {
              get: (option: { headers: Methods21['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods21['get']['resBody']>(prefix, `${prefix2}${PATH18}`, GET, option).json(),
              $get: (option: { headers: Methods21['get']['reqHeaders'], config?: T | undefined }) =>
                fetch<Methods21['get']['resBody']>(prefix, `${prefix2}${PATH18}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH18}`
            },
            patch: (option: { body: Methods20['patch']['reqBody'], headers: Methods20['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods20['patch']['resBody']>(prefix, prefix2, PATCH, option).json(),
            $patch: (option: { body: Methods20['patch']['reqBody'], headers: Methods20['patch']['reqHeaders'], config?: T | undefined }) =>
              fetch<Methods20['patch']['resBody']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
          ...
          _key: (val3: number | string) => {
            ...
            return {
              get: (option?: { headers?: Methods22['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods22['get']['resBody']>(prefix, prefix3, GET, option).json(),
              $get: (option?: { headers?: Methods22['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods22['get']['resBody']>(prefix, prefix3, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix3}`
            }
          }
        },
        get: (option: { headers: Methods19['get']['reqHeaders'], config?: T | undefined }) =>
        ...
        _userId: (val2: number) => {
          ...
          return {
            get: (option?: { headers?: Methods23['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods23['get']['resBody']>(prefix, prefix2, GET, option).json(),
            $get: (option?: { headers?: Methods23['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods23['get']['resBody']>(prefix, prefix2, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        me: {
          get: (option: { headers: Methods24['get']['reqHeaders'], config?: T | undefined }) =>
